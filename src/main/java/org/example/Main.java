...
public class Main {
    public static void main(String[] args) {
        RentController controller = new RentController(
                new RentService(new RentRepository())
        );

        List<Client> clients = List.of(
                new Client("C1", "Vaninah"),
                new Client("C2", "Jey"),
                new Client("C3", "Rakoto")
        );

        List<AbstractRental> rentals = List.of(
        ...
        Rent rentVaninah = new Rent("R1", clients.get(0),
        ...
        Rent rentJey = new Rent("R2", clients.get(1),
        ...
        Rent rentRakoto = new Rent("R3", clients.get(2),
